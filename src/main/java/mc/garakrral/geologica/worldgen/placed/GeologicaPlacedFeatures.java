...
public class GeologicaPlacedFeatures {
    public static final ResourceKey<PlacedFeature> BROKEN_ROCK = ResourceKey.create(Registries.PLACED_FEATURE, LocationUtil.modIdentifier(Geologica.MOD_ID, "broken_rock"));
